      ...
      style={{
        ...
        backgroundColor:
          ...
          checkedTasksList.some(
            (checkedTask) =>
              checkedTask.groupId === group.id && checkedTask.taskId === item.id
          )
            ? 'rgb(208,228,252)'
            : '',
      }}
    >
      <td>
        <div className="task-menu">
          ...
          >
            <MenuItem onClick={() => handleTaskDeleted(board, group, item)}>
              Delete task
            </MenuItem>
      ...
      <td>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', flexGrow: 1 }}>
            {editingTaskId === item.id ? (
              ...
              <span
                ...
                style={{
                  flexGrow: 1, // Ensures the text doesn't push the icon
          ...
          >
            <SvgIcon
              iconName={'taskdetails_bubble'}
              className={'svgOpenIcon'}
            />
          </div>
        </Link>
      </td>
