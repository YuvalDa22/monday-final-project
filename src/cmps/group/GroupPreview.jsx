				...
				<div
					...
					<div className='gh-title'>
						...
						{isEditingGroupTitle ? (
							...
							<h3 onClick={() => setIsEditingGroupTitle(true)}>{group.title || 'New Group'}</h3>
						)}
						...
						<thead>
							<tr>
								<td className='checkbox-cell'>
									<Checkbox checked={groupChecked} onChange={handleGroupChecked} size='small' />
								</td>
								<td className='task-title'>Task</td>
