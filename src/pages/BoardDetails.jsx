...
export function BoardDetails() {
  ...
  function handleDragOver(event) {
    ...
    if (activeContainer.id === overContainer.id) {
      // Swap elements within the same container
      const updatedGroupAfterSwap = swapArrayElements(activeContainer.tasks, activeIndex, overIndex)

      pendingUpdates = [{ groupId: activeContainer.id, key: 'tasks', value: updatedGroupAfterSwap }]
      return
    }
    ...
    if (activeContainer.id !== overContainer.id) {
      ...
      // Insert task at correct index without affecting "over" task order
      overContainer.tasks.splice(overIndex, 0, activeTask)
    }

    pendingUpdates = [
      { groupId: activeContainer.id, key: 'tasks', value: activeContainer.tasks },
      { groupId: overContainer.id, key: 'tasks', value: overContainer.tasks },
    ]
  }
