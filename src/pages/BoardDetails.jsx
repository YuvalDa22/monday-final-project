...
export function BoardDetails() {
  ...
  function handleDragOver(event) {
    ...
    let activeIndex = activeContainer.tasks.findIndex(
      (task) => task.id === active.id
    );
    let overIndex = overContainer.tasks.findIndex(
    ...
    if (activeContainer.id === overContainer.id) {
      ...
      const updatedGroupAfterSwap = swapArrayElements(
          ...
          <div className="footer_item-selected_container">
            ...
            <div>
              <div className="footer_colored-dots">
                {Object.entries(
                  groupCheckedTasksByColor(checkedTasksList)
                ).flatMap(([color, tasks]) =>
